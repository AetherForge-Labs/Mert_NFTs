...
export interface MertNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface MertNFT extends BaseContract {
  connect(runner?: ContractRunner | null): MertNFT;
  waitForDeployment(): Promise<this>;

  interface: MertNFTInterface;
