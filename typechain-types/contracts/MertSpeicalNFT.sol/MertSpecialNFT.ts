...
export interface MertSpecialNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface MertSpecialNFT extends BaseContract {
  connect(runner?: ContractRunner | null): MertSpecialNFT;
  waitForDeployment(): Promise<this>;

  interface: MertSpecialNFTInterface;
  ...
  mint: TypedContractMethod<[_merkleProof: BytesLike[]], [void], "nonpayable">;
  ...
  ): TypedContractMethod<[_merkleProof: BytesLike[]], [void], "nonpayable">;
  getFunction(
